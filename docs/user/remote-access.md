...
environment**. KCA restarts without a local server: no local agents or terminals run,
and other devices can no longer connect to this computer. Your projects,
