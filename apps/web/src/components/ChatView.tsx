...
export default function ChatView(props: ChatViewProps) {
  ...
  return (
    <div className="chat-surface relative flex min-h-0 min-w-0 flex-1 overflow-hidden bg-background">
      <Dialog
        open={
      ...
      >
        ...
        <WorkspacePageHeader
          ...
          className="chat-thread-panel relative bg-background"
        >
        ...
        <div className="flex min-h-0 min-w-0 flex-1">
          ...
          >
            ...
            {/* Keep the timeline's composer clearance in normal flow. The note
                ...
                lower-left corner beside the centered composer. Clearance stays
